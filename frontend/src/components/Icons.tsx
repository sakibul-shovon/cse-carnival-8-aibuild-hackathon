...
export function MegaphoneIcon({ className = 'h-5 w-5' }: IconProps) {
  return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" /></svg>;
}
export function ClipboardDocumentListIcon({ className = 'h-5 w-5' }: IconProps) {
...
export function CalendarDaysIcon({ className = 'h-5 w-5' }: IconProps) {
...
export function ChatBubbleLeftRightIcon({ className = 'h-5 w-5' }: IconProps) {
  return <svg className={className} fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={2}><path strokeLinecap="round" strokeLinejoin="round" d="M20.25 8.511c.884.284 1.5 1.128 1.5 2.097v4.286c0 1.136-.847 2.1-1.98 2.193-.34.027-.68.052-1.02.072v3.091l-3-3c-1.354 0-2.694-.055-4.02-.163a2.115 2.115 0 01-.825-.242m9.345-8.334a2.126 2.126 0 00-.476-.095 48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286c0 .837.46 1.58 1.155 1.951m9.345-8.334V6.637c0-1.136-.847-2.1-1.98-2.193a48.64 48.64 0 00-8.048 0c-1.131.094-1.976 1.057-1.976 2.192v4.286m10.151 8.334a2.126 2.126 0 01-.476.095 48.64 48.64 0 01-8.048 0c-1.131-.094-1.976-1.057-1.976-2.192v-4.286c0-.837.46-1.58 1.155-1.951" /></svg>;
}
